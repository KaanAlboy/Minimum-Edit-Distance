...
public class Test extends JFrame {
	...
	private static String MED(String input) throws FileNotFoundException {
		...
		String content = new Scanner(new File("tr_dictionary.txt")).useDelimiter("\\Z")
				.next();
		...
		for (int i = 0; i < dictionary.length; i++) {
			...
			/*
			 * for (int y2 = 0; y2 < medMatrix.length; y2++) { for (int x = 0; x <
			 * medMatrix[0].length; x++) { System.out.print(medMatrix[y2][x]); }
			 * System.out.println("\n"); }
			 */
